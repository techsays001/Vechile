                            ...
                            new SweetAlertDialog(Resetpassnurse.this, SweetAlertDialog.WARNING_TYPE)
                                    ...
                                    .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                        ...
                                        public void onClick(SweetAlertDialog sDialog) {
                                            ...
                                            StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://androidprojectstechsays.000webhostapp.com/Flatemate%20app/resetpass.php",
...
//If we are getting success from server
                            ...
                            if(response.equals("Successful"))
                               {
                         startActivity(new Intent(Resetpassnurse.this,Signinnurse.class));
                                   }
                                                            try {
