...
public class Resetpassadmin extends AppCompatActivity {
...
SharedPreferences sp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resetpassadmin);
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(npass.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(Resetpassadmin.this, "Password Noy Match ", Toast.LENGTH_LONG).show();

                }
                else if ((npass.getText().toString().equals(cnpass.getText().toString()))){


                            new SweetAlertDialog(Resetpassadmin.this, SweetAlertDialog.WARNING_TYPE)
                                    ...
                                    .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                        ...
                                        public void onClick(SweetAlertDialog sDialog) {
                                            ...
                                            StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://androidprojectstechsays.000webhostapp.com/Orphanage_manegument_system/admin_resetpass.php",
                                                    new Response.Listener<String>() {
                                                        @Override
                                                        public void onResponse(String response) {
//If we are getting success from server
                                                            Toast.makeText(Resetpassadmin.this, response, Toast.LENGTH_LONG).show();
                            if(response.equals("Successful"))
                               {
                         startActivity(new Intent(Resetpassadmin.this,Signin.class));
                                   }
                                                            try {
...
//Adding the string request to the queue
                                            RequestQueue requestQueue = Volley.newRequestQueue(Resetpassadmin.this);
